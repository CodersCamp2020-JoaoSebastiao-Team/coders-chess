...
export class Game {
    ...
    gameInit(): void {
        ...
        const pawnWhite1 = new Pawn(ChessFigure.Pawn, ChessColor.White, [0, 1]);
        this.gameFigures.push(pawnWhite1);
        const pawnWhite2 = new Pawn(ChessFigure.Pawn, ChessColor.White, [1, 1]);
        this.gameFigures.push(pawnWhite2);
        const pawnWhite3 = new Pawn(ChessFigure.Pawn, ChessColor.White, [2, 1]);
        this.gameFigures.push(pawnWhite3);
        const pawnWhite4 = new Pawn(ChessFigure.Pawn, ChessColor.White, [3, 1]);
        this.gameFigures.push(pawnWhite4);
        const pawnWhite5 = new Pawn(ChessFigure.Pawn, ChessColor.White, [4, 1]);
        this.gameFigures.push(pawnWhite5);
        const pawnWhite6 = new Pawn(ChessFigure.Pawn, ChessColor.White, [5, 1]);
        this.gameFigures.push(pawnWhite6);
        const pawnWhite7 = new Pawn(ChessFigure.Pawn, ChessColor.White, [6, 1]);
        this.gameFigures.push(pawnWhite7);
        const pawnWhite8 = new Pawn(ChessFigure.Pawn, ChessColor.White, [7, 1]);
        this.gameFigures.push(pawnWhite8);

        const rookWhiteLeft = new Rook(ChessFigure.Rook, ChessColor.White, [0, 0]);
        this.gameFigures.push(rookWhiteLeft);
        const rookWhiteRight = new Rook(ChessFigure.Rook, ChessColor.White, [7, 0]);
        this.gameFigures.push(rookWhiteRight);

        const knightWhiteLeft = new Knight(ChessFigure.Knight, ChessColor.White, [1, 0]);
        this.gameFigures.push(knightWhiteLeft);
        const knightWhiteRight = new Knight(ChessFigure.Knight, ChessColor.White, [6, 0]);
        this.gameFigures.push(knightWhiteRight);

        const bishoptWhiteLeft = new Bishop(ChessFigure.Bishop, ChessColor.White, [2, 0]);
        this.gameFigures.push(bishoptWhiteLeft);
        const bishopWhiteRight = new Bishop(ChessFigure.Bishop, ChessColor.White, [5, 0]);
        this.gameFigures.push(bishopWhiteRight);

        const kingWhite = new King(ChessFigure.King, ChessColor.White, [3, 0]);
        this.gameFigures.push(kingWhite);
        const queenWhite = new Queen(ChessFigure.Queen, ChessColor.White, [4, 0]);
