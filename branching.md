...
When development on the feature is complete, the team lead (or another team member  in charge) should merge changes into `main` and then make sure the remote branch is deleted.
...
```
$ git merge main                                  // merges changes from master into bug branch
```
